...
#--------------------------------------------------------------------
    def agregar_cliente(self, codigo, nombre, apellido, dni, deuda, tipo_impuesto):
        ...
        sql = "INSERT INTO clientes (codigo,nombre,  apellido, dni, deuda, tipo_impuesto) VALUES (%s, %s, %s, %s, %s, %s)"
        valores = (codigo, nombre, apellido, dni, deuda, tipo_impuesto)
...
#--------------------------------------------------------------------
 ...
 #-------------------------------------------------------------------   
    def modificar_cliente(self, codigo, nuevo_nombre, nuevo_apellido, nuevo_dni, nueva_deuda, nuevo_impuesto):
        sql = "UPDATE clientes SET nombre = %s, apellido = %s, dni = %s, deuda = %s, tipo_impuesto = %s WHERE codigo = %s"
        valores = (nuevo_nombre, nuevo_apellido, nuevo_dni, nueva_deuda, nuevo_impuesto, codigo)
        self.cursor.execute(sql,valores)
        self.conn.commit()
        return self.cursor.rowcount > 0  
...
# Recojo los datos del form
    ...
    if gestor_cliente.agregar_cliente(codigo, nombre, apellido, dni, deuda, tipo_impuesto):
